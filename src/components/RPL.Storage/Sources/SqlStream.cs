...
namespace Toolkit.RPL.Storage
{
	...
	/// <summary>
	/// Implements Stream on SQL Image value
	/// </summary>
	public class SqlStream : Stream
	{
		...
		private SqlImageService m_SqlImageService;
		...
		public SqlStream( int ID, SqlImageService SqlImageService )
		{
		...
		/// <summary>
		/// Class to create temporary file that will be deleted upon finalization of object
		/// or explicit Dispose() invoke
		/// </summary>
		private class TempFileStream : FileStream
		{
			...
			/// <summary>
			/// Creates temp file using system GetTempFile
			/// </summary>
			public TempFileStream()
				: base( System.IO.Path.GetTempFileName(), FileMode.Create )
			{
			...
			/// <param name="disposing">
			/// true to release both managed and unmanaged resources; 
			/// false to release only unmanaged resources.s</param>
			protected override void Dispose( bool disposing )
			{
				lock( this ) {
