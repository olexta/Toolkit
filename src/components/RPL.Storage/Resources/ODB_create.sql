USE [master]
GO
/****** Object:  Database [LineNBU]    Script Date: 08/22/2007 15:43:16 ******/
CREATE DATABASE [LineNBU] ON  PRIMARY 
( NAME = N'LineNBU', FILENAME = N'C:\LineNBU.MDF' , SIZE = 1536KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON 
( NAME = N'LineNBU_Log', FILENAME = N'c:\LineNBU.LDF' , SIZE = 1024KB , MAXSIZE = 10240KB , FILEGROWTH = 10%)
GO
EXEC dbo.sp_dbcmptlevel @dbname=N'LineNBU', @new_cmptlevel=80
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [LineNBU].[dbo].[sp_fulltext_database] @action = 'disable'
end
GO
ALTER DATABASE [LineNBU] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [LineNBU] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [LineNBU] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [LineNBU] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [LineNBU] SET ARITHABORT OFF 
GO
ALTER DATABASE [LineNBU] SET AUTO_CLOSE ON 
GO
ALTER DATABASE [LineNBU] SET AUTO_CREATE_STATISTICS ON 
GO
ALTER DATABASE [LineNBU] SET AUTO_SHRINK ON 
GO
ALTER DATABASE [LineNBU] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [LineNBU] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [LineNBU] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [LineNBU] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [LineNBU] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [LineNBU] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [LineNBU] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [LineNBU] SET  MULTI_USER 
