...
{
	/// <summary>
	/// Defines some properties of a class that it have some according bussines workflow
	/// Class contain two collections: CSMethods,CSAttributes and name of a state
	/// </summary>
	[Serializable]
	public class SState : ISerializable, IComparable
	{
		...
		/// <summary>
		/// Declare CSAttributes object
		/// </summary>
		private SProperties m_SProperties = new SProperties();

		/// <summary>
		/// Declare CSMethods object
		/// </summary>
		...
		/// <summary>
		/// Property accessor to nameField
		...
		/// <summary>
		/// Property accessor to sattributes collection.
		/// Set accessor has only internal access modifier
		/// </summary>
		...
		/// <summary>
		/// Property accessor to smethods collection
		/// Set accessor has only internal access modifier
		/// </summary>
		...
		/// <summary>
		/// Constructor of class by State name.
		/// </summary>
		...
		{
			/// <summary>
			/// Default character to indentify any State Part
			/// </summary>
			...
			/// <summary>
			/// Indicate priority of Class according to structure of parts
			/// </summary>
			private int m_priority;

			/// <summary>
			/// Constructs class based on input string.
			/// </summary>
			...
			/// <summary>
			/// Property accessor to m_priority
			/// Set accessor has only internal access modifier
			/// </summary>
			public int Priority
			{
			...
			/// <summary>
			/// Overloading of greater than or equal operator
			/// </summary>
			public static bool operator >=( SStateName lhs, SStateName rhs )
			{
				// check input parameters
