...
///<summary>This class implements collection of CSClass based on CollectionBase</summary>
[Serializable]
public class MetaData : CollectionBase, ISerializable, IDeserializationCallback, IEnumerable<SClass>
{

	///<summary>Stores path to schema. TEMP realization!</summary>
	private const string SCHEMA_PATH = "schema_output.xml";

	///<summary>Ending that refer to Caption resource for method or property</summary>
	private const string RES_CAPTION_NAME = ".Caption";
	
	///<summary>Ending that refer to Description resource for method or property</summary>
	private const string RES_DESCRIPTION_NAME = ".Description";


	///<summary>First part of file name for resourse files that contain
	/// regional settings based information</summary>
	private const string m_mui_name = "mui";

	///<summary>Default locale for regional setting.</summary>
	...
	///<summary>Used to get required information from resources
	/// based on regional settings.</summary>
	private static ResourceManager m_rm;

	///<summary>Stores schema name</summary>
	private string m_Name;

	///<summary>This is the one instance of this type.</summary>
	private static readonly MetaData m_SchemaSingleton = new MetaData();

	private bool isInited;

	///<summary>A method returning a reference to the Singleton.</summary>
	...
	///Can't reassign CSState objects, so there is no set</summary>
	...
	public SClass this[String index] {
		get {
			...
			// Raising error
			if ( _index == -1 ) throw new KeyNotFoundException("Schema of objects may be not up to date!");
			// Return index was found
			return (SClass)this.List[_index];
		}
	}

	/// <summary>Object index accessor to collection of states</summary>
	...
	///<summary>Loads curent object properties from input stream that contain
	///deserialized object typeof(CSchema)</summary>
	///<exception cref="ArgumentNullException">When input paramets contain null reference</exception>
	///<exception cref="System.Runtime.Serialization.SerializationException">When deserialization of object from stream has failed</exception>
	...
	public void InitSchema( Stream stream ) {
		...
		// check schema init state
		if (isInited) throw new InvalidOperationException("Schema is already inited");
	...
	///<summary>Returns to input parameter stream that contain
	///deserialized instance of current object</summary>
	///<exception cref="System.Runtime.Serialization.SerializationException">When serialization of object to stream has failed</exception>"
	...
	///<summary>Retrives Method or Property Caption from resource using
	/// specified CultureInfo(regional settings)</summary>
	///<param name="value">
	...
	///<summary>Retrives Method or Property Caption from resource using
	/// default CultureInfo(regional settings)</summary>
	/// <param name="value">
	///		Reference to object that implements IClassInfo</param>
	/// <param name="name">
	///		Indicates name of Parameter or Method information is needed about</param>
	...
	///<summary>Retrives Method or Property Description from resource using
	/// specified CultureInfo(regional settings)</summary>
	/// <param name="value">
	///		Reference to object that implements IClassInfo</param>
	/// <param name="name">
	...
	///<summary>Retrives DisplayOrder Property from schema</summary>
	/// <param name="value">
	///		Reference to object that implements IClassInfo</param>
	/// <param name="name">
	...
	/// <summary>Indicates wether requested Property is requiered.</summary>
	/// <param name="value">
	///		Reference to object that implements IClassInfo</param>
	/// <param name="name">
	...
	/// <summary>Indicates wether requested Method is available.</summary>
	/// <param name="value">
	///		Reference to object that implements IClassInfo</param>
	/// <param name="name">
	...
	/// <summary>Gets default value of Property.</summary>
	/// <param name="value">
	///		Reference to object that implements IClassInfo</param>
	/// <param name="name">
	///		Indicates name of Property information is needed about</param>
