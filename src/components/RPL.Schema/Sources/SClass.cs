...
{
	/// <summary>
	/// Implements collection of CSState based on CollectionBase
	/// </summary>
	[Serializable]
	public class SClass : CollectionBase, ISerializable, IDeserializationCallback
	{
		...
		/// <summary>
		/// Constructor that is used to be created for specific object
		/// </summary>
		...
		/// Can't reassign CSState objects, so there is no setter
		/// </summary>
